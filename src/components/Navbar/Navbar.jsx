        ...
        <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                <div className="navbar-nav ms-auto py-0">
                    ...
                    <Link to="package.html" className="nav-item nav-link">Packages</Link>
                    <div className="nav-item dropdown">
                        <Link to="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</Link>
                        <div className="dropdown-menu m-0">
                            <Link to="destination.html" className="dropdown-item">Destination</Link>
                            <Link to="booking.html" className="dropdown-item">Booking</Link>
                            <Link to="team.html" className="dropdown-item">Travel Guides</Link>
